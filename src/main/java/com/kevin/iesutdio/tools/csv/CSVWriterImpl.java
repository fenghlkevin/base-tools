package com.kevin.iesutdio.tools.csv;
...
public class CSVWriterImpl implements CSVWriter {
	 ...
	 */
	public CSVWriterImpl(Writer writer, char separator) {
	 ...
	 */
	public CSVWriterImpl(Writer writer, char separator, char quotechar) {
	 ...
	 */
	public CSVWriterImpl(Writer writer, char separator, char quotechar, char escapechar) {
	 ...
	 */
	public CSVWriterImpl(Writer writer, char separator, char quotechar, String lineEnd) {
	 ...
	 *            the line feed terminator to use
	 */
	public CSVWriterImpl(Writer writer, char separator, char quotechar, char escapechar, String lineEnd) {
